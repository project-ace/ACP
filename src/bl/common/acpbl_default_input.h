...
static acpbl_default_option_t default_opts[] = {
    ...
    ///
    { "multirun",           STRING, 0xffffffffffffffffLLU,     0.0e0,     "portfile", 0xffffffffffffffffLLU,  0xffffffffffffffffLLU, -0.1e0, 0.1e0 }, ///  0, IR_MULTIRUN 0
    { "multirun-offset",      UINT,                     0,     0.0e0,            NULL,                     0,              10000000, -0.1e0, 0.1e0 }, ///  1, IR_MULTIRUN_OFFSET
    ///
...
static acpbl_option_t long_options[] = {
    ...
    { "--acp-multirun",        _required_argument_, NULL, IR_MULTIRUN        }, /// 0
    { "--acp-multirun-offset", _required_argument_, NULL, IR_MULTIRUN_OFFSET }, /// 1
    ///
