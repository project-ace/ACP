...
#ifndef __ACPBL_TOFU2_SYS_H__
#define __ACPBL_TOFU2_SYS_H__
...
extern int      _acpblTofu_sys_armw_data(int flags, uint64_t remote, uint64_t local, int cmd, uint64_t write_val, uint64_t comp_val, int length, int id);
...
extern int      _acpblTofu_sys_read_status(int* comm_id, uint64_t* offset, uint64_t* data);
